...
with st.sidebar.expander("Preço do Frete"):
    frete = st.slider("Selecione o preço do Frete", 0, round(dados["Frete"].max()), (0,400))
...
with st.sidebar.expander("Nome do Vendedor"):
    vendedor = st.multiselect("Selecione o(s) vendedor(es)", dados["Vendedor"].unique(),dados["Vendedor"].unique())
